...
void loop() {
    uint8_t aux1 = get_block_value(1458561);//1458627);//
...
//    uint8_t aux5 = get_block_value(929836);
    uint8_t aux6 = get_block_value(1457307);//
//    uint8_t aux7 = get_block_value(820396);
 //   uint8_t aux8 = get_block_value(1407280);
    uint8_t aux9 = get_block_value(1458538);//1365097);//
    
    uint8_t sum = aux1 + aux2 + aux4 + aux6 + aux9;
