...
void loop() {
    ...
    uint8_t aux2 = get_block_value(56179);
    uint8_t aux3 = get_block_value(1458486);
//    uint8_t aux4 = get_block_value(1364997);
    uint8_t aux5 = get_block_value(1364997);
    uint8_t aux6 = get_block_value(1457307);
   // uint8_t aux7 = get_block_value(923624);
    uint8_t aux8 = get_block_value(820396);
    //uint8_t aux9 = get_block_value(1365097);
    
    uint8_t sum = aux1 + aux2 + aux3 + aux5 + aux6 + aux8;
