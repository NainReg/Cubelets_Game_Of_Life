...
void loop() {
    uint8_t aux1 = get_block_value(1458295);
    uint8_t aux2 = get_block_value(1458600);
    uint8_t aux3 = get_block_value(923624);
    uint8_t aux4 = get_block_value(1458286);
    uint8_t aux5 = get_block_value(1408211);
    uint8_t aux6 = get_block_value(1458297);
    uint8_t aux7 = get_block_value(1365046);
    //uint8_t aux8 = get_block_value(1370425);
    //uint8_t aux9 = get_block_value(1365097);
    
    uint8_t sum = aux1 + aux2 + aux3 + aux4 + aux5 + aux6 + aux7;
